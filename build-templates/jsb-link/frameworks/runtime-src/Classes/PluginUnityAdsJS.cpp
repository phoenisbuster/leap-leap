...
static bool js_PluginUnityAdsJS_PluginUnityAds_hide(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_PluginUnityAdsJS_PluginUnityAds_hide)
...
static bool js_PluginUnityAdsJS_PluginUnityAds_setBannerPosition(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        sdkbox::PluginUnityAds::SBUnityAdsBannerPosition arg0;
        ok &= seval_to_uint32(args[0], (uint32_t*)&arg0);
        SE_PRECONDITION2(ok, false, "js_PluginUnityAdsJS_PluginUnityAds_setBannerPosition : Error processing arguments");
        sdkbox::PluginUnityAds::setBannerPosition(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginUnityAdsJS_PluginUnityAds_setBannerPosition)
...
bool js_register_PluginUnityAdsJS_PluginUnityAds(se::Object* obj)
{
    ...
    cls->defineStaticFunction("hide", _SE(js_PluginUnityAdsJS_PluginUnityAds_hide));
    ...
    cls->defineStaticFunction("setBannerPosition", _SE(js_PluginUnityAdsJS_PluginUnityAds_setBannerPosition));
