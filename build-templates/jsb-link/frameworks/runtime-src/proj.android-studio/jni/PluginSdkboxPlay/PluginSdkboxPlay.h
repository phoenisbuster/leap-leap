...
namespace sdkbox {
    ...
    public:
         ...
         * trigger `onPlayerScores` or `onPlayerScoresError`
         */
        static void getPlayerScores( const std::string& leaderboard_name, int time_span, int collection_type, int number_of_entries );
    ...
    public:
        ...
        virtual void onPlayerScores( const std::string& leaderboard_name,
                                    int time_span, int collection_type,
                                    const std::string& json_with_score_entries ) {};
